$(document).ready(function ($) {
    ...
    function dropdownSelect(selectedItem, selectedItemShowed) {
        selectedItem.find(".dropdown-item").on("click", function (e) {
            e.preventDefault();
            if (
                $(this).parent().siblings().find(".dropdown-item").hasClass("active")
            ) {
    ...
    $(window).on("scroll", function () {
        ...
        if ($(window).scrollTop() > offsetTop) {
            processing_steps.addClass(
                "top-fixed animate__animated animate__fadeInDown",
            );
